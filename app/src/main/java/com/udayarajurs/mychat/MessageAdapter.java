        ...
        if (fromMessageType.equals("text")) {
            ...
            if(fromUserID.equals(messageSenderId)){
               ...
               // messageViewHolder.messageSenderPicture.setBackgroundResource(R.drawable.file);
                Picasso
                        .get().load("https://firebasestorage.googleapis.com/v0/b/mychat-427d2.appspot.com/o/Image%20Files%2Ffile.png?alt=media&token=64591573-6575-4d87-994f-6f81e1ff56e8").into(messageViewHolder.messageSenderPicture);
                         ...
                         builder.setItems(options, new DialogInterface.OnClickListener() {
                             ...
                             public void onClick(DialogInterface dialog, int i) {
                                 if(i == 0){
                                    ...
                                    Intent intent = new Intent(messageViewHolder.itemView.getContext(), ImageViwerActivity.class);
